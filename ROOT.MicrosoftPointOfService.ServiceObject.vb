...
Namespace ROOT.MICROSOFTPOINTOFSERVICE
    ...
    'An Early Bound class generated for the WMI class.ServiceObject
    Public Class ServiceObject
        ...
        Private Shared CreatedClassName As String = "ServiceObject"
        ...
        Public Sub New(ByVal keyName As String, ByVal keyType As String)
            MyBase.New
            Me.InitializeObject(Nothing, New System.Management.ManagementPath(ServiceObject.ConstructPath(keyName, keyType)), Nothing)
        End Sub
        
        Public Sub New(ByVal mgmtScope As System.Management.ManagementScope, ByVal keyName As String, ByVal keyType As String)
            MyBase.New
            Me.InitializeObject(CType(mgmtScope,System.Management.ManagementScope), New System.Management.ManagementPath(ServiceObject.ConstructPath(keyName, keyType)), Nothing)
        End Sub
        ...
        <Browsable(false),  _
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
        Public ReadOnly Property IsCompatibilityNull() As Boolean
            Get
                If (curObj("Compatibility") Is Nothing) Then
                    Return true
                Else
                    Return false
                End If
        ...
        Public ReadOnly Property Compatibility() As UInteger
            Get
                If (curObj("Compatibility") Is Nothing) Then
                    Return System.Convert.ToUInt32(0)
                End If
                Return CType(curObj("Compatibility"),UInteger)
            End Get
        End Property
        ...
        <Browsable(true),  _
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
        Public ReadOnly Property UposVersion() As String
            Get
                Return CType(curObj("UposVersion"),String)
            End Get
        End Property
        ...
        Private Function ShouldSerializeCompatibility() As Boolean
            If (Me.IsCompatibilityNull = false) Then
                Return true
            End If
            Return false
        End Function
        ...
        Private Shared Function ConstructPath(ByVal keyName As String, ByVal keyType As String) As String
            Dim strPath As String = "ROOT\MicrosoftPointOfService:ServiceObject"
        ...
        Public Overloads Shared Function GetInstances() As ServiceObjectCollection
            Return GetInstances(Nothing, Nothing, Nothing)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal condition As String) As ServiceObjectCollection
            Return GetInstances(Nothing, condition, Nothing)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal selectedProperties() As System.String ) As ServiceObjectCollection
            Return GetInstances(Nothing, Nothing, selectedProperties)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal condition As String, ByVal selectedProperties() As System.String ) As ServiceObjectCollection
            Return GetInstances(Nothing, condition, selectedProperties)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal enumOptions As System.Management.EnumerationOptions) As ServiceObjectCollection
            ...
            pathObj.ClassName = "ServiceObject"
            ...
            End If
            Return New ServiceObjectCollection(clsObject.GetInstances(enumOptions))
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal condition As String) As ServiceObjectCollection
            Return GetInstances(mgmtScope, condition, Nothing)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal selectedProperties() As System.String ) As ServiceObjectCollection
            Return GetInstances(mgmtScope, Nothing, selectedProperties)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal condition As String, ByVal selectedProperties() As System.String ) As ServiceObjectCollection
            If (mgmtScope Is Nothing) Then
                If (statMgmtScope Is Nothing) Then
                    mgmtScope = New System.Management.ManagementScope()
                    mgmtScope.Path.NamespacePath = "root\MicrosoftPointOfService"
                ...
                End If
            End If
            Dim ObjectSearcher As System.Management.ManagementObjectSearcher = New System.Management.ManagementObjectSearcher(mgmtScope, New SelectQuery("ServiceObject", condition, selectedProperties))
            Dim enumOptions As System.Management.EnumerationOptions = New System.Management.EnumerationOptions()
            enumOptions.EnsureLocatable = true
            ObjectSearcher.Options = enumOptions
            Return New ServiceObjectCollection(ObjectSearcher.Get)
        End Function
        
        <Browsable(true)>  _
        Public Shared Function CreateInstance() As ServiceObject
            ...
            Return New ServiceObject(tmpMgmtClass.CreateInstance)
        End Function
        ...
        Public Sub AddDevice(ByVal Path As String)
            If (isEmbedded = false) Then
                Dim inParams As System.Management.ManagementBaseObject = Nothing
                inParams = PrivateLateBoundObject.GetMethodParameters("AddDevice")
                inParams("Path") = CType(Path,System.String )
                PrivateLateBoundObject.InvokeMethod("AddDevice", inParams, Nothing)
            End If
        End Sub
        
        Public Sub DeleteDevice(ByVal Path As String)
            If (isEmbedded = false) Then
                Dim inParams As System.Management.ManagementBaseObject = Nothing
                inParams = PrivateLateBoundObject.GetMethodParameters("DeleteDevice")
                inParams("Path") = CType(Path,System.String )
                PrivateLateBoundObject.InvokeMethod("DeleteDevice", inParams, Nothing)
            End If
        End Sub
        ...
        Public Class ServiceObjectCollection
            ...
            Public Overridable Sub CopyTo(ByVal array As System.Array, ByVal index As Integer) Implements System.Collections.ICollection.CopyTo
                ...
                Do While (nCtr < array.Length)
                    array.SetValue(New ServiceObject(CType(array.GetValue(nCtr),System.Management.ManagementObject)), nCtr)
                    nCtr = (nCtr + 1)
                Loop
            End Sub
            
            Public Overridable Function GetEnumerator() As System.Collections.IEnumerator Implements System.Collections.IEnumerable.GetEnumerator
                Return New ServiceObjectEnumerator(privColObj.GetEnumerator)
            End Function
            
            Public Class ServiceObjectEnumerator
                Inherits Object
                ...
                Public Overridable ReadOnly Property Current() As Object Implements System.Collections.IEnumerator.Current
                    Get
                        Return New ServiceObject(CType(privObjEnum.Current,System.Management.ManagementObject))
                    End Get
                End Property
