...
Namespace ROOT.MICROSOFTPOINTOFSERVICE
    ...
    'An Early Bound class generated for the WMI class.POSDevice
    Public Class POSDevice
        ...
        Private Shared CreatedClassName As String = "POSDevice"
        ...
        Public Sub New(ByVal keyPath As String, ByVal keySoName As String, ByVal keyType As String)
            MyBase.New
            Me.InitializeObject(Nothing, New System.Management.ManagementPath(POSDevice.ConstructPath(keyPath, keySoName, keyType)), Nothing)
        End Sub
        
        Public Sub New(ByVal mgmtScope As System.Management.ManagementScope, ByVal keyPath As String, ByVal keySoName As String, ByVal keyType As String)
            MyBase.New
            Me.InitializeObject(CType(mgmtScope,System.Management.ManagementScope), New System.Management.ManagementPath(POSDevice.ConstructPath(keyPath, keySoName, keyType)), Nothing)
        End Sub
        ...
        <Browsable(false),  _
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
        Public ReadOnly Property IsEnabledNull() As Boolean
            Get
                If (curObj("Enabled") Is Nothing) Then
                    Return true
                Else
                    Return false
                End If
        ...
        Public Property Enabled() As Boolean
            Get
                If (curObj("Enabled") Is Nothing) Then
                    Return System.Convert.ToBoolean(0)
                End If
                Return CType(curObj("Enabled"),Boolean)
            End Get
            Set
                curObj("Enabled") = value
                If ((isEmbedded = false)  _
                            AndAlso (AutoCommitProp = true)) Then
                    PrivateLateBoundObject.Put
                End If
        ...
        <Browsable(true),  _
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
        Public ReadOnly Property HardwareDescription() As String
            Get
                Return CType(curObj("HardwareDescription"),String)
            End Get
        End Property
        
        <Browsable(false),  _
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
        Public ReadOnly Property IsIsLegacyNull() As Boolean
            Get
                If (curObj("IsLegacy") Is Nothing) Then
                    Return true
                Else
                    Return false
                End If
        ...
        Public ReadOnly Property IsLegacy() As Boolean
            Get
                If (curObj("IsLegacy") Is Nothing) Then
                    Return System.Convert.ToBoolean(0)
                End If
                Return CType(curObj("IsLegacy"),Boolean)
            End Get
        End Property
        
        <Browsable(false),  _
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>  _
        Public ReadOnly Property IsIsPlugNPlayNull() As Boolean
            Get
                If (curObj("IsPlugNPlay") Is Nothing) Then
                    Return true
                Else
                    Return false
                End If
        ...
        <Browsable(true),  _
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),  _
         TypeConverter(GetType(WMIValueTypeConverter))>  _
        Public ReadOnly Property IsPlugNPlay() As Boolean
            Get
                If (curObj("IsPlugNPlay") Is Nothing) Then
                    Return System.Convert.ToBoolean(0)
                End If
                Return CType(curObj("IsPlugNPlay"),Boolean)
            End Get
        End Property
        ...
        Private Function ShouldSerializeEnabled() As Boolean
            If (Me.IsEnabledNull = false) Then
                Return true
            End If
            Return false
        End Function
        ...
        Private Function ShouldSerializeIsLegacy() As Boolean
            If (Me.IsIsLegacyNull = false) Then
                Return true
            End If
            Return false
        End Function
        
        Private Function ShouldSerializeIsPlugNPlay() As Boolean
            If (Me.IsIsPlugNPlayNull = false) Then
                Return true
            End If
            Return false
        End Function
        ...
        Private Shared Function ConstructPath(ByVal keyPath As String, ByVal keySoName As String, ByVal keyType As String) As String
            Dim strPath As String = "ROOT\MicrosoftPointOfService:POSDevice"
            strPath = String.Concat(strPath, String.Concat(".Path=", String.Concat("""", String.Concat(keyPath, """"))))
            strPath = String.Concat(strPath, String.Concat(",SoName=", String.Concat("""", String.Concat(keySoName, """"))))
            strPath = String.Concat(strPath, String.Concat(",Type=", String.Concat("""", String.Concat(keyType, """"))))
            Return strPath
        End Function
        ...
        Public Overloads Shared Function GetInstances() As POSDeviceCollection
            Return GetInstances(Nothing, Nothing, Nothing)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal condition As String) As POSDeviceCollection
            Return GetInstances(Nothing, condition, Nothing)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal selectedProperties() As System.String ) As POSDeviceCollection
            Return GetInstances(Nothing, Nothing, selectedProperties)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal condition As String, ByVal selectedProperties() As System.String ) As POSDeviceCollection
            Return GetInstances(Nothing, condition, selectedProperties)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal enumOptions As System.Management.EnumerationOptions) As POSDeviceCollection
            ...
            End If
            Return New POSDeviceCollection(clsObject.GetInstances(enumOptions))
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal condition As String) As POSDeviceCollection
            Return GetInstances(mgmtScope, condition, Nothing)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal selectedProperties() As System.String ) As POSDeviceCollection
            Return GetInstances(mgmtScope, Nothing, selectedProperties)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal condition As String, ByVal selectedProperties() As System.String ) As POSDeviceCollection
            If (mgmtScope Is Nothing) Then
                If (statMgmtScope Is Nothing) Then
                    mgmtScope = New System.Management.ManagementScope()
                    mgmtScope.Path.NamespacePath = "root\MicrosoftPointOfService"
                ...
                End If
            End If
            Dim ObjectSearcher As System.Management.ManagementObjectSearcher = New System.Management.ManagementObjectSearcher(mgmtScope, New SelectQuery("POSDevice", condition, selectedProperties))
            Dim enumOptions As System.Management.EnumerationOptions = New System.Management.EnumerationOptions()
            enumOptions.EnsureLocatable = true
            ObjectSearcher.Options = enumOptions
            Return New POSDeviceCollection(ObjectSearcher.Get)
        End Function
        
        <Browsable(true)>  _
        Public Shared Function CreateInstance() As POSDevice
            ...
            Return New POSDevice(tmpMgmtClass.CreateInstance)
        End Function
        ...
        Public Sub AddName(ByVal Name As String)
            If (isEmbedded = false) Then
                ...
                inParams = PrivateLateBoundObject.GetMethodParameters("AddName")
                inParams("Name") = CType(Name,System.String )
                PrivateLateBoundObject.InvokeMethod("AddName", inParams, Nothing)
            End If
        End Sub
        ...
        Public Sub AddProperty(ByVal Name As String, ByVal Value As String)
            If (isEmbedded = false) Then
                Dim inParams As System.Management.ManagementBaseObject = Nothing
                inParams = PrivateLateBoundObject.GetMethodParameters("AddProperty")
                inParams("Name") = CType(Name,System.String )
                inParams("Value") = CType(Value,System.String )
                PrivateLateBoundObject.InvokeMethod("AddProperty", inParams, Nothing)
            End If
        End Sub
        ...
        Public Sub DeleteName(ByVal Name As String)
            If (isEmbedded = false) Then
                Dim inParams As System.Management.ManagementBaseObject = Nothing
                inParams = PrivateLateBoundObject.GetMethodParameters("DeleteName")
                inParams("Name") = CType(Name,System.String )
                PrivateLateBoundObject.InvokeMethod("DeleteName", inParams, Nothing)
            End If
        End Sub
        
        Public Sub DeleteProperty(ByVal Name As String)
            If (isEmbedded = false) Then
                Dim inParams As System.Management.ManagementBaseObject = Nothing
                inParams = PrivateLateBoundObject.GetMethodParameters("DeleteProperty")
                inParams("Name") = CType(Name,System.String )
                PrivateLateBoundObject.InvokeMethod("DeleteProperty", inParams, Nothing)
            End If
        End Sub
        ...
        Public Sub SetPath(ByVal Path As String)
            If (isEmbedded = false) Then
                Dim inParams As System.Management.ManagementBaseObject = Nothing
                inParams = PrivateLateBoundObject.GetMethodParameters("SetPath")
                inParams("Path") = CType(Path,System.String )
                PrivateLateBoundObject.InvokeMethod("SetPath", inParams, Nothing)
            End If
        End Sub
        
        'Enumerator implementation for enumerating instances of the class.
        Public Class POSDeviceCollection
            Inherits Object
            ...
            Public Overridable Sub CopyTo(ByVal array As System.Array, ByVal index As Integer) Implements System.Collections.ICollection.CopyTo
                ...
                Do While (nCtr < array.Length)
                    array.SetValue(New POSDevice(CType(array.GetValue(nCtr),System.Management.ManagementObject)), nCtr)
                    nCtr = (nCtr + 1)
                Loop
            End Sub
            
            Public Overridable Function GetEnumerator() As System.Collections.IEnumerator Implements System.Collections.IEnumerable.GetEnumerator
                Return New POSDeviceEnumerator(privColObj.GetEnumerator)
            End Function
            
            Public Class POSDeviceEnumerator
                Inherits Object
                ...
                Public Overridable ReadOnly Property Current() As Object Implements System.Collections.IEnumerator.Current
                    Get
                        Return New POSDevice(CType(privObjEnum.Current,System.Management.ManagementObject))
                    End Get
                End Property
