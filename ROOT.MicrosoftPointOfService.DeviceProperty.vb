...
Namespace ROOT.MICROSOFTPOINTOFSERVICE
    ...
    'An Early Bound class generated for the WMI class.DeviceProperty
    Public Class DeviceProperty
        ...
        Private Shared CreatedClassName As String = "DeviceProperty"
        ...
        Public Sub New(ByVal keyName As String, ByVal keyPath As String, ByVal keySoName As String, ByVal keyType As String)
            MyBase.New
            Me.InitializeObject(Nothing, New System.Management.ManagementPath(DeviceProperty.ConstructPath(keyName, keyPath, keySoName, keyType)), Nothing)
        End Sub
        
        Public Sub New(ByVal mgmtScope As System.Management.ManagementScope, ByVal keyName As String, ByVal keyPath As String, ByVal keySoName As String, ByVal keyType As String)
            MyBase.New
            Me.InitializeObject(CType(mgmtScope,System.Management.ManagementScope), New System.Management.ManagementPath(DeviceProperty.ConstructPath(keyName, keyPath, keySoName, keyType)), Nothing)
        End Sub
        ...
        Public ReadOnly Property Value() As String
            Get
                Return CType(curObj("Value"),String)
            End Get
        End Property
        ...
        Private Shared Function ConstructPath(ByVal keyName As String, ByVal keyPath As String, ByVal keySoName As String, ByVal keyType As String) As String
            Dim strPath As String = "ROOT\MicrosoftPointOfService:DeviceProperty"
        ...
        Public Overloads Shared Function GetInstances() As DevicePropertyCollection
            Return GetInstances(Nothing, Nothing, Nothing)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal condition As String) As DevicePropertyCollection
            Return GetInstances(Nothing, condition, Nothing)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal selectedProperties() As System.String ) As DevicePropertyCollection
            Return GetInstances(Nothing, Nothing, selectedProperties)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal condition As String, ByVal selectedProperties() As System.String ) As DevicePropertyCollection
            Return GetInstances(Nothing, condition, selectedProperties)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal enumOptions As System.Management.EnumerationOptions) As DevicePropertyCollection
            ...
            pathObj.ClassName = "DeviceProperty"
            ...
            End If
            Return New DevicePropertyCollection(clsObject.GetInstances(enumOptions))
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal condition As String) As DevicePropertyCollection
            Return GetInstances(mgmtScope, condition, Nothing)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal selectedProperties() As System.String ) As DevicePropertyCollection
            Return GetInstances(mgmtScope, Nothing, selectedProperties)
        End Function
        
        Public Overloads Shared Function GetInstances(ByVal mgmtScope As System.Management.ManagementScope, ByVal condition As String, ByVal selectedProperties() As System.String ) As DevicePropertyCollection
            If (mgmtScope Is Nothing) Then
                If (statMgmtScope Is Nothing) Then
                    mgmtScope = New System.Management.ManagementScope()
                    mgmtScope.Path.NamespacePath = "root\MicrosoftPointOfService"
                ...
                End If
            End If
            Dim ObjectSearcher As System.Management.ManagementObjectSearcher = New System.Management.ManagementObjectSearcher(mgmtScope, New SelectQuery("DeviceProperty", condition, selectedProperties))
            Dim enumOptions As System.Management.EnumerationOptions = New System.Management.EnumerationOptions()
            enumOptions.EnsureLocatable = true
            ObjectSearcher.Options = enumOptions
            Return New DevicePropertyCollection(ObjectSearcher.Get)
        End Function
        
        <Browsable(true)>  _
        Public Shared Function CreateInstance() As DeviceProperty
            ...
            Return New DeviceProperty(tmpMgmtClass.CreateInstance)
        End Function
        ...
        Public Class DevicePropertyCollection
            Inherits Object
            ...
            Public Overridable Sub CopyTo(ByVal array As System.Array, ByVal index As Integer) Implements System.Collections.ICollection.CopyTo
                ...
                Do While (nCtr < array.Length)
                    array.SetValue(New DeviceProperty(CType(array.GetValue(nCtr),System.Management.ManagementObject)), nCtr)
                    nCtr = (nCtr + 1)
                Loop
            End Sub
            
            Public Overridable Function GetEnumerator() As System.Collections.IEnumerator Implements System.Collections.IEnumerable.GetEnumerator
                Return New DevicePropertyEnumerator(privColObj.GetEnumerator)
            End Function
            
            Public Class DevicePropertyEnumerator
                Inherits Object
                ...
                Public Overridable ReadOnly Property Current() As Object Implements System.Collections.IEnumerator.Current
                    Get
                        Return New DeviceProperty(CType(privObjEnum.Current,System.Management.ManagementObject))
                    End Get
                End Property
